                    ...
                    <v-list class="transparent pb-0" dense>
                        <v-list-item two-line>
                            <v-list-item-content>
                                ...
                                <v-list-item-subtitle>{{ productData.product_number }} {{ productData.product_model }}</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                        <v-divider></v-divider>
...
<!--                                <v-list-item-subtitle>{{ productData.product_number_replacements }}</v-list-item-subtitle>-->
<!--                            </v-list-item-content>-->
<!--                        </v-list-item>-->
                        <v-list-item two-line dense>
                            <v-list-item-content>
...
<!--                                <v-list-item-subtitle>{{ productData.product_number_inner }}</v-list-item-subtitle>-->
<!--                            </v-list-item-content>-->
<!--                        </v-list-item>-->
<!--                        <v-list-item two-line dense>-->
<!--                            <v-list-item-content>-->
<!--                                <v-list-item-title>Марка</v-list-item-title>-->
<!--                                <v-list-item-subtitle>{{ productData.product_model }}</v-list-item-subtitle>-->
<!--                            </v-list-item-content>-->
<!--                        </v-list-item>-->
                    </v-list>
                </v-col>
